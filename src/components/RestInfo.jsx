        ...
        <>
          <div className="flex w-full justify-between mb-2 pb-2">
            ...
            <div className="w-[20%] relative">
                <img className="w-full h-36 object cover rounded-3xl" src={"https://media-assets.swiggy.com/swiggy/image/upload/"+ restData?.imageId}  />
                <button className="absolute bottom-1 left-20 rounded-xl text-2xl  text-green-600  shadow-md border border-white px-4 py-2 bg-white">ADD</button>
            </div>
          </div>
